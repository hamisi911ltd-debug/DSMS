...
import { User, Mail, Phone, Car, LogOut, Edit, Save, X } from 'lucide-react';
    ...
    <div className="space-y-4">
      <Card className="bg-gradient-to-br from-neon-blue/20 to-neon-purple/20 border-neon-blue/30">
        <div className="flex flex-col items-center">
          <div className="w-24 h-24 rounded-full bg-gradient-to-br from-neon-blue to-neon-purple flex items-center justify-center mb-4">
